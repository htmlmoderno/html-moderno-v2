...
module.exports = [
  ...
  ['meta', { name: 'google-site-verification', content: 'OvzxEtwcvhlGAQT7HQJ9er54r4_PjzsY_MHtIpZgSd8' }], // google
  ['meta', { name: 'msvalidate.01', content: 'D879F8AEF42B5DE5143B8CD3D109EEC4' }], // bing
  ['meta', { name: 'p:domain_verify', content: 'd982b6ae262730ac300bf7409a8e35ea' }], // pinterest
  ['meta', { name: 'yandex-verification', content: '4f882473380b34b6' }], // Yandex
